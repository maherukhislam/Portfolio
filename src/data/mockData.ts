...
export const portfolioData = {
  ...
  projects: {
    ...
    featured: {
      ...
      tags: ["React 18", "Serverless Edge", "Supabase"],
      ...
      caseStudy: {
        ...
        solution: "Engineered and deployed a highly optimized SPA utilizing Cloudflare Pages Edge APIs, a headless Supabase PostgreSQL backend with Row-Level Security, and R2 Object Storage.",
        impact: "Connected student directories, automated notices via Edge functions, secured CMS access via JWTs, and established clear institutional presence.",
        technologies: ["React 18", "TypeScript", "Cloudflare Pages & Workers", "Supabase PostgreSQL", "Cloudflare R2"],
        challenges: "Ensuring cross-device compatibility while maintaining sub-second edge delivery speeds and resilient lazy-loaded chunks.",
      },
    ...
    secondary: [
      {
        ...
        tags: ["React 19", "Zustand", "Cloudflare", "Supabase"],
        ...
        caseStudy: {
          ...
          solution: "Built a decoupled serverless treasury platform with a React 19 + Zustand frontend, Cloudflare Pages APIs, and Supabase PostgreSQL with strict RBAC.",
          impact: "Eliminated manual ledger errors; enforced parity across client and server with a shared calculation engine, reducing audit duration from 3 days to under 1 second.",
          technologies: ["React 19", "Zustand", "Cloudflare Functions", "Supabase PostgreSQL & Auth", "Cloudflare R2"],
          challenges: "Ensuring 100% calculation parity between dashboard reports and final statements while securing transactions via CSRF tokens and HttpOnly cookies.",
        },
      },
      {
